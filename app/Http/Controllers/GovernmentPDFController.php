...
class GovernmentPDFController extends Controller
{
    function index()
    {
     $customer_data = $this->get_customer_data();
     return view('hll.governmentpdf')->with('customer_data', $customer_data);
    }

    function get_customer_data()
    {
     $customer_data = DB::table('mdespatches')
     ->get();
    ...
    <th style="border: 1px solid; padding:6px;" width="3%">Date</th>
     ...
     foreach($customer_data as $customer)
     {
      ...
      <tr>
       ...
       <td style="border: 1px solid; padding:8px;">'.$customer->inn.'</td>
